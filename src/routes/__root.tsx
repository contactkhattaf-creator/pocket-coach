...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Sage — AI money coach for your pocket" },
      { name: "description", content: "Sage is the AI-powered money app for students and young pros. Track expenses, decode your spending, and grow your Financial Discipline Score in real time." },
      { name: "author", content: "Sage" },
      { property: "og:title", content: "Sage — AI money coach for your pocket" },
