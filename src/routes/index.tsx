...
function Index() {
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-6 lg:grid-cols-12">
          <div className="lg:col-span-7">
            ...
            <p className="reveal mt-6 max-w-xl text-lg text-ink/70">
              Moniq tracks every dirham, decodes your spending personality, and turns saving into a daily streak.
          ...
          <div className="reveal relative lg:col-span-5">
            ...
            <div className="absolute -left-6 top-16 z-20 hidden rotate-[-8deg] rounded-2xl bg-white px-4 py-3 shadow-card ring-1 ring-ink/5 sm:block float-slow">
              ...
              <p className="font-display text-xl font-bold text-ink">+24.10 MAD</p>
            </div>
      ...
      <section className="px-6 py-16 sm:py-24">
        <div className="reveal mx-auto max-w-7xl rounded-[2.5rem] bg-violet-bright/95 p-10 shadow-card sm:p-16 lg:p-20"
          ...
          <div className="grid items-center gap-10 lg:grid-cols-2">
            <div>
              <p className="text-xs font-semibold uppercase tracking-[0.25em] text-white/70">The Moniq way</p>
              ...
              <p className="mt-5 max-w-lg text-white/80">
                Moniq's AI watches patterns — not just numbers. It nudges you with tiny wins,
            ...
            <div className="relative mx-auto w-full max-w-sm">
              <img src={heroCollage} alt="Young person checking the Moniq dashboard" className="rounded-3xl object-cover shadow-card"
  ...
  function Features() {
    const features = [
      { tag: "Track", title: "Every dirham, auto-categorized", body: "Add a transaction in 2 clicks. Moniq learns merchants, splits, and recurring charges automatically.", color: "bg-cream" },
      { tag: "Decode", title: "Your money personality", body: "Are you a mindful spender, a social flamer, or a careful saver? Moniq finds your profile in days.", color: "bg-lavender" },
      ...
      { tag: "Save", title: "Goals that feel like games", body: "Trip to Marrakech, new laptop, emergency cushion. Moniq breaks it into weekly micro-objectives.", color: "bg-white" },
  ...
  function HowItWorks() {
    const steps = [
      ...
      { n: "02", t: "Moniq learns your patterns", b: "In a week, our AI maps your habits and finds your money personality." },
      ...
      <section id="ai" className="px-6 py-16 sm:py-24">
        <div className="reveal mx-auto max-w-7xl overflow-hidden rounded-[2.5rem] bg-dark-card p-10 text-white shadow-card sm:p-16 lg:p-20"
          ...
          <div className="grid items-center gap-12 lg:grid-cols-12">
            <div className="lg:col-span-7">
              <p className="text-xs font-semibold uppercase tracking-[0.25em] text-violet-bright">Why Moniq is different</p>
              <h2 className="mt-4 font-display text-4xl font-bold leading-tight sm:text-5xl">
                Other apps log spending. <span className="text-violet-bright">Moniq understands it.</span>
              </h2>
      ...
      <section className="py-24 sm:py-32">
        <div className="mx-auto grid max-w-7xl items-center gap-14 px-6 lg:grid-cols-2">
          <div className="reveal relative">
            <img src={collage1} alt="Student using Moniq" className="rounded-[2rem] shadow-card" width={800} height={1000} loading="lazy" />
          ...
          <div className="relative grid items-center gap-10 lg:grid-cols-2">
            <div>
              ...
              <p className="mt-5 max-w-lg text-white/70">
                Start building real money habits with Moniq today.
                Free forever for the basics.
              </p>
              <div className="mt-8 flex flex-wrap gap-3">
                <Link to="/register" className="pill-btn-bright">Create free account</Link>
                <Link to="/login" className="rounded-full border border-white/20 px-7 py-3.5 text-sm font-semibold text-white transition hover:bg-white/10">Sign in</Link>
              </div>
            </div>
            <div className="relative">
              <img src={collage2} alt="Young pro using Moniq" className="mx-auto w-72 rotate-[4deg] rounded-3xl shadow-card sm:w-80" width={800} height={1000} loading="lazy" />
            </div>
          </div>
        </div>
      </section>
  ...
  function FAQ() {
    const items = [
      { q: "Is Moniq really free?", a: "Yes — tracking, AI insights, and FDS are free forever. Premium adds investing simulators and advanced coaching." },
      { q: "Do I need to link my bank?", a: "No. You can use Moniq manually, entering your transactions yourself. Your call." },
      { q: "Will Moniq do real trades?", a: "Not yet. Moniq is a coach and simulator — designed to teach, not to risk your savings." },
      ...
      <footer className="border-t border-ink/10 bg-lavender-soft px-6 py-16">
        <div className="mx-auto max-w-7xl">
            ...
            {[
              ...
              <div key={c.h}>
                ...
                <ul className="mt-4 space-y-2 text-sm text-ink/65">
                  {c.l.map((x) => (
                    <li key={x.text}>
                      <a href={x.href} className="hover:text-ink" {...(x.href.startsWith("http") ? { target: "_blank", rel: "noopener noreferrer" } : {})}>{x.text}</a>
                    </li>
                  ))}
                </ul>
              </div>
          ...
          <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-ink/10 pt-6 text-xs text-ink/50 sm:flex-row">
            <p>© 2026 Moniq. All rights reserved.</p>
